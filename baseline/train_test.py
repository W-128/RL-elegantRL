def test(cfg, env, agent):
    ...
    print('超供程度：{:.1f}%'.format(env.get_more_provision_degree() * 100))
    print('超供平均值：{:.1f}'.format(env.get_more_provision_mean()))
    print('超供总量：{:.1f}'.format(env.get_more_provision_sum()))
