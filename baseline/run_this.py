...
class EDF:
    ...
    def submit_request(self):
        ...
        for i in range(the_first_remaining_time_more_than_zero_index):
            if remaining_num > 0:
    ...
    def step(self):
        ...
        if episode_done:
            ...
            print('超供量：{:.1f}'.format(self.get_more_provision()))
        return episode_done
