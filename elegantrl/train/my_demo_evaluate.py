...
def evaluate_agent():
    ...
    actor_path = './RequestEnvNoSim_PPO_0/actor_00131022_00225.600.pth'
    act.load_state_dict(
    ...
    print(
        ...
        .format(r_avg, success_rate_avg, more_provision_sum_avg,
                more_provision_rate_avg, more_than_threshold_rate_avg,
                variance_avg, s_avg))
